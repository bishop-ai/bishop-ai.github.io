angular.module('AI').controller('PluginsCtrl', [
    ...
    function ($rootScope,
        ...
        $http.get("https://davidpaulhamilton.net/bishop-ai/api/packages").then(function (response) {
            $scope.loadingAvailable = false;
        ...
        var updatePlugin = function (plugin) {
            $scope.saving = true;
            return $http.put("https://davidpaulhamilton.net/bishop-ai/api/plugins/" + plugin.name, plugin).then(function (response) {
                $scope.saving = false;
                return response;
            }, function (error) {
                $scope.saving = false;
        ...
        $scope.installPackage = function (pkg) {
            $http.post("https://davidpaulhamilton.net/bishop-ai/api/packages/", pkg).then(function () {
